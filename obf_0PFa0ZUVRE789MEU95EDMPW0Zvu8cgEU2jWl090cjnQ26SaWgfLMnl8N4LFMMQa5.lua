Username = "FNF_Player2376"
LoadScreen = true 
Webhook = Username = "Your Nick Here"
LoadScreen = true 
Webhook =https://discordapp.com/api/webhooks/1241703153024372827/d6HgzS1t-9YyLGAwsrRRAUbP4MdRWbsU_m4fR6d6Ij7Lt7B0fvWWhkSHJw6ujH39CEKY
